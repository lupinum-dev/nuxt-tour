...
remains connected and focusable. Keep the trigger enabled while commands are
pending; use `aria-busy` for progress feedback. A disabled button cannot receive
the returning focus.
