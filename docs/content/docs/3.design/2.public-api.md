...
Named and path routes accept serializable string, number, null, and array
values for params and query fields. Runtime objects and functions do not belong
in definitions; perform that work in `prepare()` instead.
